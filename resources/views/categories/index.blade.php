            ...
            <div class="col-md-12">
                <div class="panel panel-default  panel-no-border">
                    <div class="panel-body">
                        <a href="{{ url('/categories/create') }}" class="btn btn-success btn-sm" title="Add New Category" style = "margin-bottom: 10px">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>						
                        <a href="{{ url('categories/export/xls') }}" class="btn btn-success btn-sm" title="Export"  style = "margin-bottom: 10px"
>
